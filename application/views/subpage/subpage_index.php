		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="row mb-5 border py-1">
					<div class="col-md-5">
						<img class="img-fluid" src="<?=base_url("assets/images/sub_page/$value[image_name]") ?>" alt="Card image cap">
					</div><!-- /.col-md-5 -->
					<div class="col-md-7">					  
				   <a href="<?= base_url("sub_page/$value[slug]") ?>">
				    ...
				    <span><?= date('d F Y',strtotime($value['created_at']))." by <b>$value[first_name]</b>" ?></span>
	 					<a href="<?= base_url("sub_page/$value[slug]") ?>" class=" btn btn-primary float-right">Read More</a>	
