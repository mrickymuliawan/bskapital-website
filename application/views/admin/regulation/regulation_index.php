...
<div class="box">
  <div class="box-header with-border">
    <a href="<?= base_url('admin/regulation/create')?>" class="btn btn-primary">Create regulation</a>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>Are you sure want to delete this regulation?</p>
        <small>Data cannot be recover</small>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
        <a href="<?= base_url("admin/regulation/delete/")?>" class="btn btn-outline">Yes, delete this</a>
      </div>
    </div>
    <!-- /.modal-content -->
  </div>
...
<script>
  $('.btn-delete').click(function() {
    var regulation_id=$(this).val();
    var href=$('.modal-delete a').attr('href');
    $('.modal-delete a').attr('href',href+regulation_id);
  })
