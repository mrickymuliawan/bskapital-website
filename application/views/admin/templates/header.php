...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="" class="logo">
      ...
      <span class="logo-mini"><b>B</b>SK</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>BS</b>KAPITAL</span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?= base_url('assets/adminlte/dist/img/admin.png') ?>" class="user-image" alt="User Image">
